...
public class TeleporterSkyr extends Teleporter {
	...
	public TeleporterSkyr(WorldServer par1WorldServer) {
			...
			for (int var14 = -2; var14 <= 2; ++var14) {
				for (int var15 = -2; var15 <= 2; ++var15) {
					for (int var16 = -1; var16 < 3; ++var16) {
						...
						this.field_85192_a.setBlockWithNotify(var17, var18,
								var19, var20 ? Block.blockLapis.blockID : 0);
					}
				}
			}
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2,
		...
		if (this.field_85191_c.containsItem(var17)) {
			PortalPosition var20 = (PortalPosition) this.field_85191_c
					.getValueByKey(var17);
			var10 = 0.0D;
			var12 = var20.posX;
			var13 = var20.posY;
			...
			for (var48 = var15 - var9; var48 <= var15 + var9; ++var48) {
				...
				for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23) {
					...
					for (int var26 = this.field_85192_a.getActualHeight() - 1; var26 >= 0; --var26) {
						if (this.field_85192_a.getBlockId(var48, var26, var23) == Skyr.SkyrPortal.blockID) {
							while (this.field_85192_a.getBlockId(var48,
									var26 - 1, var23) == Skyr.SkyrPortal.blockID) {
								--var26;
							}
		...
		if (var10 >= 0.0D) {
			if (var19) {
				this.field_85191_c.add(var17, new PortalPosition(this, var12,
						var13, var14, this.field_85192_a.getTotalWorldTime()));
			...
			if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == Skyr.SkyrPortal.blockID) {
				var50 = 2;
			}
			...
			if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == Skyr.SkyrPortal.blockID) {
				var50 = 3;
			}
			...
			if (var50 > -1) {
				...
				boolean var36 = !this.field_85192_a.isAirBlock(var12 + var32
						+ var34, var13, var14 + var33 + var35)
						|| !this.field_85192_a.isAirBlock(
								var12 + var32 + var34, var13 + 1, var14 + var33
										+ var35);
				boolean var37 = !this.field_85192_a.isAirBlock(var12 + var32,
						var13, var14 + var33)
						|| !this.field_85192_a.isAirBlock(var12 + var32,
								var13 + 1, var14 + var33);
				...
				if (var36 && var37) {
					...
					var27 -= (double) var35;
					var36 = !this.field_85192_a.isAirBlock(var48 + var32
							+ var34, var13, var22 + var33 + var35)
							|| !this.field_85192_a.isAirBlock(var48 + var32
									+ var34, var13 + 1, var22 + var33 + var35);
					var37 = !this.field_85192_a.isAirBlock(var48 + var32,
							var13, var22 + var33)
							|| !this.field_85192_a.isAirBlock(var48 + var32,
									var13 + 1, var22 + var33);
				}
				...
				var49 += (double) ((float) var34 * var38 + var39
						* (float) var32);
				var27 += (double) ((float) var35 * var38 + var39
						* (float) var33);
				float var40 = 0.0F;
				float var41 = 0.0F;
				float var42 = 0.0F;
			...
			par1Entity.setLocationAndAngles(var49 + 3, var25, var27 + 3,
			...
			for (var16 = var7 - var2; var16 <= var7 + var2; ++var16) {
				...
				for (var19 = this.field_85192_a.getActualHeight() - 1; var19 >= 0; --var19) {
					if (this.field_85192_a.isAirBlock(var13, var19, var16)) {
						while (var19 > 0
								&& this.field_85192_a.isAirBlock(var13,
										var19 - 1, var16)) {
							--var19;
						}
			...
			for (var19 = -1; var19 <= 1; ++var19) {
				for (var20 = 1; var20 < 3; ++var20) {
					for (var21 = -1; var21 < 3; ++var21) {
						...
						var33 = var21 < 0;
						this.field_85192_a.setBlockWithNotify(var22, var23,
								var24, var33 ? Block.blockLapis.blockID : 0);
					}
				}
			}
		}
		...
		for (var19 = 0; var19 < 4; ++var19) {
			...
			for (var20 = 0; var20 < 4; ++var20) {
				for (var21 = -1; var21 < 4; ++var21) {
					...
					var33 = var20 == 0 || var20 == 3 || var21 == -1
							|| var21 == 3;
					this.field_85192_a.setBlockWithNotify(var22, var23, var24,
							var33 ? Block.blockLapis.blockID
									: Skyr.SkyrPortal.blockID);
				}
			}
			...
			for (var20 = 0; var20 < 4; ++var20) {
				for (var21 = -1; var21 < 4; ++var21) {
					...
					var23 = var15 + var21;
					var24 = var16 + (var20 - 1) * var18;
					this.field_85192_a.notifyBlocksOfNeighborChange(var22,
							var23, var24,
							this.field_85192_a.getBlockId(var22, var23, var24));
				}
			}
		}
