...
public class ChunkProviderSkyr implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderSkyr(World par1World, long par2, boolean par4)
    {
        ...
        this.b = new NoiseGeneratorOctaves(this.rand, 10);
    ...
    public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        ...
        for (int var8 = 0; var8 < 16; ++var8)
        {
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                for (int var16 = 127; var16 >= 0; --var16)//127 DEAFUTOL
                {
                    int var17 = (var9 * 16 + var8) * 128 + var16;

                    if (var16 <= 10)//64
                    {//var16 <= 0 + this.rand.nextInt(125))
                        par3ArrayOfByte[var17] = (byte)0;//EVERYTHING BELOW Y64 = NULLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL DED
                    }
                    else
                    {
